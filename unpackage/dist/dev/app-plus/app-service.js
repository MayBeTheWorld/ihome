...
`, "color: #ffffff; background: #3c9cff; padding:5px 0;", "color: #3c9cff;background: #ffffff; padding:5px 0;");
  ...
  const __easycom_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$k], ["__scopeId", "data-v-1c933a9a"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-icon/u-icon.vue"]]);
  const props$a = {
    props: {
      // 文字颜色
      color: {
  ...
  const __easycom_1$5 = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["render", _sfc_render$j], ["__scopeId", "data-v-dedad317"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-link/u-link.vue"]]);
  const value = {
    computed: {
      // 经处理后需要显示的值
      value() {
  ...
  const uvText = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$i], ["__scopeId", "data-v-5fec1d8b"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-text/u-text.vue"]]);
  const _sfc_main$p = {
    name: "u--text",
  ...
  const __easycom_1$4 = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$h], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u--text/u--text.vue"]]);
  const props$8 = {
    props: {
      // 头像图片路径(不能为相对路径)
      src: {
  ...
  function _sfc_render$g(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_u_icon = resolveEasycom(vue.resolveDynamicComponent("u-icon"), __easycom_0$5);
    const _component_u__text = resolveEasycom(vue.resolveDynamicComponent("u--text"), __easycom_1$4);
    return vue.openBlock(), vue.createElementBlock(
      "view",
      {
  ...
  const __easycom_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["render", _sfc_render$g], ["__scopeId", "data-v-14a988f2"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-avatar/u-avatar.vue"]]);
  const _sfc_main$n = {
    props: {
      value: Array,
      column: {
  ...
  const __easycom_2$2 = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["render", _sfc_render$f], ["__scopeId", "data-v-6aaf0fae"], ["__file", "D:/Projects/爱佳装/uni_modules/custom-waterfalls-flow/components/custom-waterfalls-flow/custom-waterfalls-flow.vue"]]);
  const _sfc_main$m = {
    __name: "publicTabBar",
    props: {
      activePage: {
        ...
        if (aim != props2.activePage) {
          switch (aim) {
            case "0":
              ...
              formatAppLog("log", "at components/publicTabBar/publicTabBar.vue:67", "跳转首页");
              break;
            case "1":
              uni.switchTab({
                url: "../../pages/VR/VR"
  ...
  const publicTabBar = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-4e7366ac"], ["__file", "D:/Projects/爱佳装/components/publicTabBar/publicTabBar.vue"]]);
  ...
  const scan = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$e], ["__file", "D:/Projects/爱佳装/components/scan/scan.vue"]]);
  ...
  const _sfc_main$k = {
    ...
    setup(__props) {
      ...
      function openScan() {
        ...
        formatAppLog("log", "at pages/index/index.vue:310", "父组件触发打开");
      }
      function closeScan() {
        scanRef.value.close();
        isShowScan.value = false;
        formatAppLog("log", "at pages/index/index.vue:316", "父组件触发关闭");
      }
      function getScanCode(val) {
        formatAppLog("log", "at pages/index/index.vue:320", "父组件扫码成功");
        closeScan();
        uni.showToast({
          icon: "none",
          title: "扫码成功"
      ...
      const m = () => {
        formatAppLog("log", "at pages/index/index.vue:344", styleItem.value);
      };
      ...
      function swiperChange(e) {
        ...
        formatAppLog("log", "at pages/index/index.vue:354", e.detail.current);
      }
      ...
      function saveArticle(item) {
        if (collectIds.indexOf(item.id) == -1) {
          ...
          formatAppLog("log", "at pages/index/index.vue:428", "收藏成功");
        } else {
          collectIds.splice(collectIds.indexOf(item.id), 1);
          formatAppLog("log", "at pages/index/index.vue:431", "收藏取消");
        }
      }
      function addNew(list0) {
        let length = list0.length;
        list0.push({
          image: "https://image.16pic.com/00/11/59/16pic_1159705_s.jpg?imageView2/0/format/png",
          title: "",
          desc: "这个二层别墅是个外观不出挑的简欧风格，比起看到的很多华丽造型的欧式建筑，这个简欧住宅更偏向于一种复古的氛围感，浅黄色墙面砖就素雅了许多，拱形门洞也给人欧式古堡感觉，虽大体上比较现代化，但氛围感却十足",
          id: list0[length - 1].id + 1
        });
        list0.push({
          image: "https://image.16pic.com/00/11/59/16pic_1159705_s.jpg?imageView2/0/format/png",
          title: "",
      ...
      return (_ctx, _cache) => {
        ...
        const _component_u_icon = resolveEasycom(vue.resolveDynamicComponent("u-icon"), __easycom_0$5);
        const _component_custom_waterfalls_flow = resolveEasycom(vue.resolveDynamicComponent("custom-waterfalls-flow"), __easycom_2$2);
        return vue.openBlock(), vue.createElementBlock(
          vue.Fragment,
          null,
          [
                    ...
                    vue.createElementVNode("scroll-view", {
                      ...
                      vue.createElementVNode("view", null, [
                        ...
                        vue.createElementVNode("button", {
                          onClick: _cache[5] || (_cache[5] = ($event) => addNew(data.list0))
                        }, "增加")
                      ])
                    ])
                  ]),
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__file", "D:/Projects/爱佳装/pages/index/index.vue"]]);
  class BaseLang {
  }
  ...
  const deepMerge$2 = (target, newObj) => {
    Object.keys(newObj).forEach((key) => {
      ...
      if (isObject$1(targetValue) && isObject$1(newObjValue)) {
  ...
  const __easycom_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$d], ["__file", "D:/Projects/爱佳装/uni_modules/sky-nutui/components/sky-nutui/packages/__VUE/icon/index.vue"]]);
  const overlayProps = {
    visible: {
      type: Boolean,
      default: false
  ...
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$c], ["__scopeId", "data-v-07ec1718"], ["__file", "D:/Projects/爱佳装/uni_modules/sky-nutui/components/sky-nutui/packages/__VUE/overlay/index.vue"]]);
  let count = 0;
  ...
  const __easycom_1$3 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$b], ["__scopeId", "data-v-ce54da7a"], ["__file", "D:/Projects/爱佳装/uni_modules/sky-nutui/components/sky-nutui/packages/__VUE/popup/index.vue"]]);
  ...
  const _sfc_main$g = create$1({
    ...
    components: {
      [__easycom_0$3.name]: __easycom_0$3,
      [__easycom_1$3.name]: __easycom_1$3
    },
  ...
  function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_nut_icon = resolveEasycom(vue.resolveDynamicComponent("nut-icon"), __easycom_0$3);
    const _component_nut_popup = resolveEasycom(vue.resolveDynamicComponent("nut-popup"), __easycom_1$3);
  ...
  const __easycom_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$a], ["__scopeId", "data-v-8f4b114a"], ["__file", "D:/Projects/爱佳装/uni_modules/sky-nutui/components/sky-nutui/packages/__VUE/menuitem/index.vue"]]);
  ...
  const __easycom_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$9], ["__scopeId", "data-v-3b380ba4"], ["__file", "D:/Projects/爱佳装/uni_modules/sky-nutui/components/sky-nutui/packages/__VUE/menu/index.vue"]]);
  const props$7 = {
    props: {
      // 指示器的整体宽度
      indicatorWidth: {
        type: [String, Number],
        default: props$c.scrollList.indicatorWidth
      },
      // 滑块的宽度
      indicatorBarWidth: {
        type: [String, Number],
        default: props$c.scrollList.indicatorBarWidth
      },
      // 是否显示面板指示器
      indicator: {
        type: Boolean,
        default: props$c.scrollList.indicator
      },
      // 指示器非激活颜色
      indicatorColor: {
        type: String,
        default: props$c.scrollList.indicatorColor
      },
      // 指示器的激活颜色
      indicatorActiveColor: {
        type: String,
        default: props$c.scrollList.indicatorActiveColor
      },
      // 指示器样式，可通过bottom，left，right进行定位
      indicatorStyle: {
        type: [String, Object],
        default: props$c.scrollList.indicatorStyle
      }
    }
  };
  const block0 = (Comp) => {
  ...
  if (typeof block0 === "function")
    block0(_sfc_main$e);
  const __easycom_4$1 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$8], ["__scopeId", "data-v-fea2b4f4"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-scroll-list/u-scroll-list.vue"]]);
  const _sfc_main$d = {
    name: "UniCard",
    emits: ["click"],
    props: {
  ...
  const __easycom_5 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$7], ["__scopeId", "data-v-ae4bee67"], ["__file", "D:/Projects/爱佳装/uni_modules/uni-card/components/uni-card/uni-card.vue"]]);
  const props$6 = {
    props: {
      // 用于滚动到指定item
      anchor: {
  ...
  const __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$6], ["__scopeId", "data-v-32197ac9"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-list-item/u-list-item.vue"]]);
  const props$5 = {
    props: {
      // 控制是否出现滚动条，仅nvue有效
      showScrollbar: {
  ...
  const __easycom_4 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$5], ["__scopeId", "data-v-9ad03670"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-list/u-list.vue"]]);
  const _sfc_main$a = {
    __name: "VR",
    setup(__props) {
      const state = vue.reactive({
      ...
      const left = () => {
        formatAppLog("log", "at pages/VR/VR.vue:143", "left");
      };
      const right = () => {
        formatAppLog("log", "at pages/VR/VR.vue:146", "right");
      };
      const scrolltolower = () => {
        formatAppLog("log", "at pages/VR/VR.vue:149", "scrolltolower");
        for (let i = 0; i < 5; i++) {
      ...
      return (_ctx, _cache) => {
        ...
        const _component_nut_menu_item = resolveEasycom(vue.resolveDynamicComponent("nut-menu-item"), __easycom_1$2);
        const _component_nut_menu = resolveEasycom(vue.resolveDynamicComponent("nut-menu"), __easycom_2$1);
        const _component_u_icon = resolveEasycom(vue.resolveDynamicComponent("u-icon"), __easycom_0$5);
        const _component_u_scroll_list = resolveEasycom(vue.resolveDynamicComponent("u-scroll-list"), __easycom_4$1);
        const _component_uni_card = resolveEasycom(vue.resolveDynamicComponent("uni-card"), __easycom_5);
        const _component_u_list_item = resolveEasycom(vue.resolveDynamicComponent("u-list-item"), __easycom_3);
        const _component_u_list = resolveEasycom(vue.resolveDynamicComponent("u-list"), __easycom_4);
        return vue.openBlock(), vue.createElementBlock("view", { class: "systemBox" }, [
          ...
          vue.createCommentVNode('    <nut-button type="primary">主要按钮</nut-button>'),
                                      ...
                                      (vue.openBlock(true), vue.createElementBlock(
                                        ...
                                        vue.renderList(list2.value, (item2, index3) => {
                                          return vue.openBlock(), vue.createElementBlock(
                                            "view",
                                            {
                                              class: vue.normalizeClass(["scroll-list__goods-item", [index3 === 9 && "scroll-list__goods-item--no-margin-right"]]),
                                              key: index3
                                            },
                                            [
                                              vue.createElementVNode("image", {
  ...
  const PagesVRVR = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__file", "D:/Projects/爱佳装/pages/VR/VR.vue"]]);
  const props$4 = {
    props: {
      color: {
        type: String,
  ...
  const __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$4], ["__scopeId", "data-v-bbd9963c"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-line/u-line.vue"]]);
  const props$3 = {
    props: {
      // 标题
      title: {
  ...
  const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$3], ["__scopeId", "data-v-b4243719"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-cell/u-cell.vue"]]);
  const _sfc_main$7 = {
    __name: "news",
    setup(__props) {
      const state = vue.reactive({
      ...
      const loadmore2 = () => {
        ...
        formatAppLog("log", "at pages/news/news.vue:62", "loadmore");
      };
      return (_ctx, _cache) => {
        const _component_publicTabBar = resolveEasycom(vue.resolveDynamicComponent("publicTabBar"), publicTabBar);
        const _component_u_avatar = resolveEasycom(vue.resolveDynamicComponent("u-avatar"), __easycom_0$4);
        const _component_u_cell = resolveEasycom(vue.resolveDynamicComponent("u-cell"), __easycom_2);
        const _component_u_list_item = resolveEasycom(vue.resolveDynamicComponent("u-list-item"), __easycom_3);
        const _component_u_list = resolveEasycom(vue.resolveDynamicComponent("u-list"), __easycom_4);
        return vue.openBlock(), vue.createElementBlock("view", { class: "systemBox" }, [
            ...
            vue.createVNode(_component_u_list, { onScrolltolower: scrolltolower }, {
              default: vue.withCtx(() => [
                (vue.openBlock(true), vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList(state.indexList, (item, index2) => {
                    return vue.openBlock(), vue.createBlock(
                      _component_u_list_item,
                      { key: index2 },
                      {
  ...
  const PagesNewsNews = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__file", "D:/Projects/爱佳装/pages/news/news.vue"]]);
  const _sfc_main$6 = {
    __name: "main",
    setup(__props) {
      ...
      function loginout() {
        ...
        formatAppLog("log", "at pages/main/main.vue:148", "成功退出登录");
        uni.reLaunch({
          url: "/pages/main/main"
        });
      }
  ...
  const PagesMainMain = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__file", "D:/Projects/爱佳装/pages/main/main.vue"]]);
  const props$2 = {
    props: {
      // 显示的内容，字符串
      text: {
        type: [Array],
        default: props$c.columnNotice.text
      },
      // 是否显示左侧的音量图标
      icon: {
        type: String,
        default: props$c.columnNotice.icon
      },
      // 通告模式，link-显示右箭头，closable-显示右侧关闭图标
      mode: {
        type: String,
        default: props$c.columnNotice.mode
      },
      // 文字颜色，各图标也会使用文字颜色
      color: {
        type: String,
        default: props$c.columnNotice.color
      },
      // 背景颜色
      bgColor: {
        type: String,
        default: props$c.columnNotice.bgColor
      },
      // 字体大小，单位px
      fontSize: {
        type: [String, Number],
        default: props$c.columnNotice.fontSize
      },
      // 水平滚动时的滚动速度，即每秒滚动多少px(px)，这有利于控制文字无论多少时，都能有一个恒定的速度
      speed: {
        type: [String, Number],
        default: props$c.columnNotice.speed
      },
      // direction = row时，是否使用步进形式滚动
      step: {
        type: Boolean,
        default: props$c.columnNotice.step
      },
      // 滚动一个周期的时间长，单位ms
      duration: {
        type: [String, Number],
        default: props$c.columnNotice.duration
      },
      // 是否禁止用手滑动切换
      // 目前HX2.6.11，只支持App 2.5.5+、H5 2.5.5+、支付宝小程序、字节跳动小程序
      disableTouch: {
        type: Boolean,
        default: props$c.columnNotice.disableTouch
      }
    }
  };
  const _sfc_main$5 = {
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$2], ["__scopeId", "data-v-6c9dce4e"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-column-notice/u-column-notice.vue"]]);
  const props$1 = {
    props: {
      // 显示的内容，字符串
      text: {
        type: String,
        default: props$c.rowNotice.text
      },
      // 是否显示左侧的音量图标
      icon: {
        type: String,
        default: props$c.rowNotice.icon
      },
      // 通告模式，link-显示右箭头，closable-显示右侧关闭图标
      mode: {
        type: String,
        default: props$c.rowNotice.mode
      },
      // 文字颜色，各图标也会使用文字颜色
      color: {
        type: String,
        default: props$c.rowNotice.color
      },
      // 背景颜色
      bgColor: {
        type: String,
        default: props$c.rowNotice.bgColor
      },
      // 字体大小，单位px
      fontSize: {
        type: [String, Number],
        default: props$c.rowNotice.fontSize
      },
      // 水平滚动时的滚动速度，即每秒滚动多少px(rpx)，这有利于控制文字无论多少时，都能有一个恒定的速度
      speed: {
        type: [String, Number],
        default: props$c.rowNotice.speed
      }
    }
  };
  const _sfc_main$4 = {
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$1], ["__scopeId", "data-v-462e724c"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-row-notice/u-row-notice.vue"]]);
  const props = {
    props: {
      // 显示的内容，数组
      text: {
        type: [Array, String],
        default: props$c.noticeBar.text
      },
      // 通告滚动模式，row-横向滚动，column-竖向滚动
      direction: {
        type: String,
        default: props$c.noticeBar.direction
      },
      // direction = row时，是否使用步进形式滚动
      step: {
        type: Boolean,
        default: props$c.noticeBar.step
      },
      // 是否显示左侧的音量图标
      icon: {
        type: String,
        default: props$c.noticeBar.icon
      },
      // 通告模式，link-显示右箭头，closable-显示右侧关闭图标
      mode: {
        type: String,
        default: props$c.noticeBar.mode
      },
      // 文字颜色，各图标也会使用文字颜色
      color: {
        type: String,
        default: props$c.noticeBar.color
      },
      // 背景颜色
      bgColor: {
        type: String,
        default: props$c.noticeBar.bgColor
      },
      // 水平滚动时的滚动速度，即每秒滚动多少px(px)，这有利于控制文字无论多少时，都能有一个恒定的速度
      speed: {
        type: [String, Number],
        default: props$c.noticeBar.speed
      },
      // 字体大小
      fontSize: {
        type: [String, Number],
        default: props$c.noticeBar.fontSize
      },
      // 滚动一个周期的时间长，单位ms
      duration: {
        type: [String, Number],
        default: props$c.noticeBar.duration
      },
      // 是否禁止用手滑动切换
      // 目前HX2.6.11，只支持App 2.5.5+、H5 2.5.5+、支付宝小程序、字节跳动小程序
      disableTouch: {
        type: Boolean,
        default: props$c.noticeBar.disableTouch
      },
      // 跳转的页面路径
      url: {
        type: String,
        default: props$c.noticeBar.url
      },
      // 页面跳转的类型
      linkType: {
        type: String,
        default: props$c.noticeBar.linkType
      }
    }
  };
  const _sfc_main$3 = {
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render], ["__scopeId", "data-v-63dbbc8e"], ["__file", "D:/Projects/爱佳装/node_modules/uview-plus/components/u-notice-bar/u-notice-bar.vue"]]);
  const _sfc_main$2 = {
    __name: "testLogin",
    setup(__props) {
      const store2 = useStore();
  ...
  const PagesSubpagesLoginTestLogin = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__file", "D:/Projects/爱佳装/pages/subpages/login/testLogin.vue"]]);
  const _sfc_main$1 = {
    __name: "login",
    setup(__props) {
      const store2 = useStore();
      ...
      function bindLogin() {
        ...
        if (!userAccount.length) {
          alert2("请输入账号");
          formatAppLog("log", "at pages/subpages/login/login.vue:120", "请输入账号");
          return false;
        }
        if (password.length < 6) {
          alert2("密码最短为 6 个字符");
          formatAppLog("log", "at pages/subpages/login/login.vue:130", "密码最短为 6 个字符");
          return false;
        }
        uni.showLoading({
          title: "登录中"
        });
        formatAppLog("log", "at pages/subpages/login/login.vue:139", account.value + "," + password.value);
        uni.$u.http.post("http://43.140.203.85:8102/user/login", {
          ...
          formatAppLog("log", "at pages/subpages/login/login.vue:146", res);
          if (res) {
            formatAppLog("log", "at pages/subpages/login/login.vue:148", "登录成功");
          } else {
            uni.showToast({
              icon: "none",
              title: "登录失败",
          ...
          formatAppLog("log", "at pages/subpages/login/login.vue:167", err);
        });
        uni.hideLoading();
      }
      function alert2(msg) {
  ...
  const PagesSubpagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "D:/Projects/爱佳装/pages/subpages/login/login.vue"]]);
