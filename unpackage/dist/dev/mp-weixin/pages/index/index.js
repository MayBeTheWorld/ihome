...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const listStyle = {
      "box-shadow": "0px 1.7px 3.6px rgba(0, 0, 0, 0.024),0px 4.6px 10px rgba(0, 0, 0, 0.035),0px 11.2px 24.1px rgba(0, 0, 0, 0.046),0px 37px 80px rgba(0, 0, 0, 0.07)"
    };
      ...
      return {
        ...
        m: common_vendor.f(data.list0, (item, index, i0) => {
          return {
            ...
            d: common_vendor.o(($event) => saveArticle(item)),
            e: index
          };
        }),
        n: common_vendor.p({
        ...
        w: common_vendor.sr(waterfallsFlowRef, "40860e84-4", {
          "k": "waterfallsFlowRef"
        }),
        x: common_vendor.p({
          column: column.value,
        ...
        y: common_vendor.f(data.list0, (item, index, i0) => {
          return {
            a: common_vendor.t(item.desc),
        ...
        B: common_vendor.sr(waterfallsFlowRef, "40860e84-7", {
          "k": "waterfallsFlowRef"
        }),
        C: common_vendor.p({
          column: column.value,
        ...
        G: common_vendor.sr(waterfallsFlowRef, "40860e84-10", {
          "k": "waterfallsFlowRef"
        }),
        H: common_vendor.p({
          column: column.value,
        ...
        I: common_vendor.f(data.list0, (item, index, i0) => {
          return {
            a: common_vendor.t(item.desc),
        ...
        L: common_vendor.sr(waterfallsFlowRef, "40860e84-13", {
          "k": "waterfallsFlowRef"
        }),
        M: common_vendor.p({
          column: column.value,
